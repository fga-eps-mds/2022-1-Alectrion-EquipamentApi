...
export class default1662309419389 implements MigrationInterface {
  name = 'default1662309419389'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "order_service" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "date" date NOT NULL, "description" character varying NOT NULL, "author_id" uuid NOT NULL, "sender" character varying NOT NULL, "sender_functional_number" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "destinationId" uuid, CONSTRAINT "REL_204a4d8643816109bde984d5b8" UNIQUE ("destinationId"), CONSTRAINT "PK_d33d62cc4f08f6bd10dd7a68f65" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
